...
def getRegimen(typeOfPatient, monthOfTreatment, isExtraPulmonary):
    ...
    elif monthOfTreatment in ["7 Month", "8 Month", "9 Month", "10 Month"]:
        if isExtraPulmonary or (typeOfPatient == "Treatment after failure"):
            return "RH"
        else:
            return ""

    elif monthOfTreatment in ["11 Month", "12 Month"] and isExtraPulmonary:
        return "RH"

    else:
        return ""

def getPillCount(weight):
...
def getNumberOfBlisterPacks(weight):
    pillCount = getPillCount(weight)
    pillsPerPack = 28;
            ...
            match treatmentElement['id']:
                ...
                case "Ghsh3wqVTif":
                    if regimen == "RHZE":
                        ...
                        value = f"{getNumberOfBlisterPacks(weight)}"
